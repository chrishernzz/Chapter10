...
template <class Item>
string AnimalGuessingGame<Item>::remove_brackets(const string& str)
{
    string result = str;
...
template <class Item>
AnimalGuessingGame<Item>* AnimalGuessingGame<Item>::build_tree_from_file(ifstream& file)
{
    string line;
    getline(file, line);
    ...
    AnimalGuessingGame<Item>* root = new AnimalGuessingGame<Item>(remove_brackets(line));
...
// Constructor
// Precondition: None.
// Postcondition: Creates a new instance of AnimalGuessingGame with given data, left, and right pointers.
template <class Item>
AnimalGuessingGame<Item>::AnimalGuessingGame(const Item& init_data, AnimalGuessingGame* init_left, AnimalGuessingGame* init_right)
{
...
template <class Item>
Item& AnimalGuessingGame<Item>::data()
{
    return data_field;
}
...
template <class Item>
AnimalGuessingGame<Item>*& AnimalGuessingGame<Item>::left()
{
    return left_field;
}
...
template <class Item>
AnimalGuessingGame<Item>*& AnimalGuessingGame<Item>::right()
{
    return right_field;
}
...
template <class Item>
void AnimalGuessingGame<Item>::set_data(const Item& new_data)
{
    data_field = new_data;
}
...
template <class Item>
void AnimalGuessingGame<Item>::set_left(AnimalGuessingGame* new_left)
{
    left_field = new_left;
}
...
template <class Item>
void AnimalGuessingGame<Item>::set_right(AnimalGuessingGame* new_right)
{
...
template <class Item>
const Item& AnimalGuessingGame<Item>::data() const
{
    return data_field;
}
...
template <class Item>
const AnimalGuessingGame<Item>* AnimalGuessingGame<Item>::left() const
{
    return left_field;
}
...
template <class Item>
const AnimalGuessingGame<Item>* AnimalGuessingGame<Item>::right() const
{
    return right_field;
}
...
template <class Item>
bool AnimalGuessingGame<Item>::is_leaf() const
{
...
template <class Item>
void AnimalGuessingGame<Item>::tree_clear(AnimalGuessingGame<Item>*& root_ptr)
{
    AnimalGuessingGame<Item>* child;
    if (root_ptr != nullptr)
    {
        child = root_ptr->left();
        tree_clear(child);
...
template <class Item>
AnimalGuessingGame<Item>* AnimalGuessingGame<Item>::tree_copy(const AnimalGuessingGame<Item>* root_ptr)
{
    AnimalGuessingGame<Item>* l_ptr;
    AnimalGuessingGame<Item>* r_ptr;
    if (root_ptr == nullptr)
        return nullptr;
    else
    {
        ...
        return new AnimalGuessingGame<Item>(root_ptr->data(), l_ptr, r_ptr);
    }
}
...
template <class Item>
AnimalGuessingGame<Item>* AnimalGuessingGame<Item>::beginning_tree(const string& file_name)
{
...
// Precondition: 'current_ptr' points to a valid AnimalGuessingGame node.
// Postcondition: Prints the data of the current node, asks the user a yes/no question, and moves 'current_ptr' accordingly.
template <class Item>
void AnimalGuessingGame<Item>::ask_and_move(AnimalGuessingGame<string>*& current_ptr)
{
    cout << "\n\t\t\t" << current_ptr->data();
...
template <class Item>
void AnimalGuessingGame<Item>::learn(AnimalGuessingGame<string>* leaf_ptr)
{
    ...
    if (inquire(" (Y-yes/N-no) "))
    {
        leaf_ptr->set_left(new AnimalGuessingGame<string>(correct_animal));
        leaf_ptr->set_right(new AnimalGuessingGame<string>(guess_animal));
    }
    else
    {
        leaf_ptr->set_left(new AnimalGuessingGame<string>(guess_animal));
        leaf_ptr->set_right(new AnimalGuessingGame<string>(correct_animal));
    }
}

// Precondition: 'current_ptr' points to the root of the AnimalGuessingGame tree.
// Postcondition: Plays the game, making guesses and learning if necessary based on user input.
template <class Item>
void AnimalGuessingGame<Item>::play(AnimalGuessingGame<string>* current_ptr)
{
...
// Precondition: None.
// Postcondition: Saves the current AnimalGuessingGame tree to the file with the given name.
template <class Item>
void AnimalGuessingGame<Item>::save_tree_to_file(const string& file_name)
{
...
// Precondition: 'file' is a valid output file stream. 'root' points to a valid AnimalGuessingGame node.
// Postcondition: Recursively saves the AnimalGuessingGame tree to the file with proper formatting.
template <class Item>
void AnimalGuessingGame<Item>::save_tree_to_file_recursive(ofstream& file, AnimalGuessingGame<string>* root)
{
    if (root == nullptr)
    {
        return;
...
template <class Item>
void AnimalGuessingGame<Item>::mainInformation()
{
    AnimalGuessingGame<string>* taxonomy_root_ptr;

    // Use the correct function name: beginning_tree
    taxonomy_root_ptr = AnimalGuessingGame<string>::beginning_tree("animal.txt");
